    ...
    <body class="bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 min-h-screen flex flex-col">
        ...
        <header class="absolute inset-x-0 top-0 z-10 flex items-center justify-between px-6 py-4 lg:px-10">
            <div class="flex items-center gap-2">
                ...
                <span class="font-semibold text-white drop-shadow">{{ __(config('app.name')) }}</span>
            </div>
        ...
        <div class="flex-1 bg-zinc-50 dark:bg-zinc-900 px-6 py-16 lg:px-10">
            <div class="max-w-4xl mx-auto grid gap-8 sm:grid-cols-3">
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-zinc-100">{{ __('Books') }}</h3>
                    <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Log every book you\'ve read, with ratings, reviews, and your favourites.') }}</p>
                </div>
                <div class="text-center">
                    <div class="inline-flex items-center justify-center size-12 rounded-xl bg-zinc-200 dark:bg-zinc-800 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-zinc-600 dark:text-zinc-300" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-zinc-100">{{ __('TV Shows') }}</h3>
                    <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Track seasons and episodes across all the series you follow.') }}</p>
                </div>
                <div class="text-center">
                    <div class="inline-flex items-center justify-center size-12 rounded-xl bg-zinc-200 dark:bg-zinc-800 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-zinc-600 dark:text-zinc-300" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-zinc-100">{{ __('Movies') }}</h3>
                    <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Keep a personal record of every film you\'ve seen.') }}</p>
                </div>
            </div>
        </div>
